...
<div class="actions">
	...
	<ul class="list-unstyled">
		<li><?php echo $this->Html->link(__('New Organization'), array('action' => 'add'),
		...
		array('class' => 'btn btn-primary btn-xs')); ?> </li>
		<li><?php echo $this->Html->link(__('List Editions'), array('controller' => 'editions', 'action' => 'index'),
		array('class' => 'btn btn-primary btn-xs')); ?> </li>
		<li><?php echo $this->Html->link(__('New Edition'), array('controller' => 'editions', 'action' => 'add'),
		array('class' => 'btn btn-primary btn-xs')); ?> </li>
		<li><?php echo $this->Html->link(__('List Organizers'), array('controller' => 'organizers', 'action' => 'index'),
		array('class' => 'btn btn-primary btn-xs')); ?> </li>
		<li><?php echo $this->Html->link(__('New Organizer'), array('controller' => 'organizers', 'action' => 'add'),
		array('class' => 'btn btn-primary btn-xs')); ?> </li>
	</ul>
</div>
